...
export const arrowEl = document.getElementById('direction-arrow');
export const speedEl = document.getElementById('speed-indicator');
...
export const dirWarning = document.getElementById('direction-warning');
